...
import { Alert, Avatar, Button, Card, Container, Group, SimpleGrid, Stack, Text, TextInput, Title, Image, Badge } from '@mantine/core';
    ...
    const fetchNFTs = async () => {
      ...
      if (myERC721Contract && myERC721Contract.runner) {
        ...
        for (let i = 0; i < balance; i++) {
          // ERC721Enumerableメソッドを利用して、Indexから自身が保有するNFTのtokenIdを取得
          const tokenId = await myERC721Contract.tokenOfOwnerByIndex(myAddress, i);
          // NOTE: 本来は下記のようにtokenIdからJson Metadataを取得しNFTのコンテンツ情報にアクセス
